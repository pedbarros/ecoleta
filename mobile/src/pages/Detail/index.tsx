...
const Detail: React.FC = () => {
  ...
  function handleWhatsapp() {
    Linking.openURL(`whatsapp://send?phone=${point.whatsapp}&text=Tenho interesse sobre coleta de residuo`)
  }
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <Text style={styles.pointItems}>
          {point.items ? point.items.map(item => item.title).join(', ') : 'Sem pontos de coleta'}
        </Text>
